...
/*
 * Setup for Snowcap STM32F4 v1 board.
 */

/*
 * Board identifier.
 */
#define BOARD_SNOWCAP_STM32F4_V1
#define BOARD_NAME              "Snowcap STM32F4 Board v1"
 ...
 * PA3  - PIN4                      (input pullup).
 * PA3  - PIN5                      (input pullup).
 * PA3  - PIN6                      (input pullup).
 * PA3  - PIN7                      (input pullup).
 ...
 * PB9  - PIN7                      (input pullup).
 * PB10 - PIN8                      (input pullup).
