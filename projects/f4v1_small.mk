...
SC_DEFINES += -DPORT_INT_REQUIRED_STACK=32 -DEVENT_MB_SIZE=8 -DSC_BLOB_MAX_SIZE=1 -DSC_CMD_MAX_RECV_BUF_LEN=0

# Disable Chibios debugging, save  ~1k RAM.
SC_DEFINES += -DCH_DBG_SYSTEM_STATE_CHECK=FALSE -DCH_DBG_ENABLE_ASSERTS=FALSE -DCH_DBG_ENABLE_TRACE=FALSE -DCH_DBG_ENABLE_STACK_CHECK=FALSE -DCH_DBG_FILL_THREADS=FALSE -DCH_DBG_THREADS_PROFILING=FALSE
...
SC_DEFINES += -DCH_USE_REGISTRY=FALSE -DCH_USE_CONDVARS=FALSE -DCH_USE_MESSAGES=FALSE -DCH_USE_MEMCORE=FALSE -DCH_USE_HEAP=FALSE -DCH_USE_MEMPOOLS=FALSE -DCH_USE_DYNAMIC=FALSE